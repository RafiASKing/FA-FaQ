...
def combine_files(root_dir, output_file, extensions):
    ...
    EXCLUDE_DIRS = ['venv', '.git', '__pycache__', 'node_modules', 'images', 'data', '.env','backup'] 
    ...
    EXCLUDE_FILES = ['faq_data.xlsx', 'scriptjalanfiles.py', 'single_script_for_llm.txt','Dokumentasi.md','info_some_syntax.md','README.md'] # scriptjalanfiles.py diabaikan agar tidak menggabungkan dirinya sendiri
