...
| **Logic Pencarian** | Hanya menampilkan list flat tanpa batas yang jelas. | **Split Logic (Search vs Browse):**<br>• **Search Mode:** Hanya menampilkan **Top 3** hasil terbaik (Relevansi \>41%).<br>• **Browse Mode:** Menampilkan **Top 10** data terbaru jika search bar kosong. |
